  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="flex items-start max-sm:flex-col max-sm:items-center">
        <div className="rounded-full bg-red-100 h-12 w-12 sm:h-10 sm:w-10 sm:mx-0 flex items-center justify-center flex-shrink-0 ">
          <FiAlertTriangle className={"text-red-600 h-6 w-6 "} />
        </div>
        <div className="ml-4 mt-3 sm:mt-0 text-center sm:text-left">
          <Dialog.Title
            as="h3"
